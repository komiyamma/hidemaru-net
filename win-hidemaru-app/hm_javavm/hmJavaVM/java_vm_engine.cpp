...
jlong CJavaVMEngine::CallStaticEntryMethodOfLong(wstring class_name, wstring method_name, jlong a1, jlong a2, jlong a3, string method_args_typedef_string, string method_args_declare_string) {

#include "CallStaticEntryMethodStart1.tmpl"
#include "CallStaticEntryMethodStartReturnLong.tmpl"

	// mainメソッド実行 ★この行が違うだけ
	jlong ret = env->CallStaticLongMethod(clazz, mid, a1, a2, a3);
...
jlong CJavaVMEngine::CallStaticEntryMethodOfLong(wstring class_name, wstring method_name, wstring s1, wstring s2, wstring s3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnLong.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	jlong ret = env->CallStaticLongMethod(clazz, mid, js_arg1, js_arg2, js_arg3);
...
jlong CJavaVMEngine::CallStaticEntryMethodOfLong(wstring class_name, wstring method_name, jlong a1, wstring s2, wstring s3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnLong.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	jlong ret = env->CallStaticLongMethod(clazz, mid, a1, js_arg2, js_arg3);
...
jlong CJavaVMEngine::CallStaticEntryMethodOfLong(wstring class_name, wstring method_name, wstring s1, jlong a2, wstring s3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnLong.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	jlong ret = env->CallStaticLongMethod(clazz, mid, js_arg1, a2, js_arg3);
...
jlong CJavaVMEngine::CallStaticEntryMethodOfLong(wstring class_name, wstring method_name, wstring s1, wstring s2, jlong a3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnLong.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	jlong ret = env->CallStaticLongMethod(clazz, mid, js_arg1, js_arg2, a3);
...
wstring CJavaVMEngine::CallStaticEntryMethodOfString(wstring class_name, wstring method_name, jlong a1, jlong a2, jlong a3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnString.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	auto jstr = static_cast<jstring>(env->CallStaticObjectMethod(clazz, mid, a1, a2, a3));
	std::wstring result = jstring_to_utf16(env, jstr);
	env->DeleteLocalRef(jstr);
...
wstring CJavaVMEngine::CallStaticEntryMethodOfString(wstring class_name, wstring method_name, wstring s1, wstring s2, wstring s3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnString.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	auto jstr = static_cast<jstring>(env->CallStaticObjectMethod(clazz, mid, js_arg1, js_arg2, js_arg3));
	std::wstring result = jstring_to_utf16(env, jstr);
	env->DeleteLocalRef(jstr);
...
#include "CallStaticEntryMethodStartReturnString.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	auto jstr = static_cast<jstring>(env->CallStaticObjectMethod(clazz, mid, a1, js_arg2, js_arg3));
	std::wstring result = jstring_to_utf16(env, jstr);
	env->DeleteLocalRef(jstr);
...
wstring CJavaVMEngine::CallStaticEntryMethodOfString(wstring class_name, wstring method_name, wstring s1, jlong a2, wstring s3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnString.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	auto jstr = static_cast<jstring>(env->CallStaticObjectMethod(clazz, mid, js_arg1, a2, js_arg3));
	std::wstring result = jstring_to_utf16(env, jstr);
	env->DeleteLocalRef(jstr);
...
wstring CJavaVMEngine::CallStaticEntryMethodOfString(wstring class_name, wstring method_name, wstring s1, wstring s2, jlong a3, string method_args_typedef_string, string method_args_declare_string) {
...
#include "CallStaticEntryMethodStartReturnString.tmpl"
	...
	// mainメソッド実行 ★この行が違うだけ
	auto jstr = static_cast<jstring>(env->CallStaticObjectMethod(clazz, mid, js_arg1, js_arg2, a3));
	std::wstring result = jstring_to_utf16(env, jstr);
	env->DeleteLocalRef(jstr);
