...
JNIEXPORT jdouble JNICALL Java_Hm_GetVersion() {
	return CHidemaruExeExport::hm_version;
}


// EvalMacro
JNIEXPORT jint JNICALL Java_Hm_EvalMacro(JNIEnv *env, jobject obj, jstring value) {
...
// 秀丸マクロのシンボルや変数の値の取得。
JNIEXPORT jstring JNICALL Java_Hm_GetMacroVarObj(JNIEnv *env, jobject obj, jstring key_name) {
...
JNIEXPORT jint JNICALL Java_Hm_SetMacroVarNum(JNIEnv *env, jobject obj, jstring key_name, jlong value) {
	jint success = false;
...
JNIEXPORT jint JNICALL Java_Hm_SetMacroVarStr(JNIEnv *env, jobject obj, jstring key_name, jstring value) {
	jint success = false;
...
// GetTotalText。
JNIEXPORT jstring JNICALL Java_Hm_GetTotalText(JNIEnv *env, jobject obj) {

	return utf16_to_jstring(env, CHidemaruExeExport::GetTotalText());
}

// SetTotalText
JNIEXPORT jint JNICALL Java_Hm_SetTotalText(JNIEnv *env, jobject obj, jstring value) {
	jint success = false;
...
// GetSelectedText。
JNIEXPORT jstring JNICALL Java_Hm_GetSelectedText(JNIEnv *env, jobject obj) {

	return utf16_to_jstring(env, CHidemaruExeExport::GetSelectedText());
}

// SetSelectedText
JNIEXPORT jint JNICALL Java_Hm_SetSelectedText(JNIEnv *env, jobject obj, jstring value) {
	jint success = false;
...
// GetLineText。
JNIEXPORT jstring JNICALL Java_Hm_GetLineText(JNIEnv *env, jobject obj) {

	return utf16_to_jstring(env, CHidemaruExeExport::GetLineText());
}

// SetLineText
JNIEXPORT jint JNICALL Java_Hm_SetLineText(JNIEnv *env, jobject obj, jstring value) {
	jint success = false;
...
// GetCursorPos
JNIEXPORT jstring JNICALL Java_Hm_GetCursorPos(JNIEnv *env, jobject obj) {
...
JNIEXPORT jstring JNICALL Java_Hm_GetCursorPosFromMousePos(JNIEnv *env, jobject obj) {
