...
public sealed partial class hmRbDynamicLib
{
    public sealed partial class Hidemaru
    {
        ...
        public class HmMacro
        {
            ...
            internal static bool _IsExecuting
            {
                get
                {
            ...
            {
                return _ExecEval(cmd);
            }
            internal static IResult _ExecEval(String cmd)
            {
            ...
            private List<KeyValuePair<string, object>> SetMacroVarAndMakeMacroKeyArray(object[] args, int base_random)
            {
                ...
                foreach (var ref_value in args)
                {
                    ...
                    if (!success)
                    {
                        ...
                        if (value.GetType().Name == "RubyArray")
                        {
                            ...
                            try
                            {
                                ...
                                RubyArray value_list = (RubyArray)value;
                                ...
                                if (value_list.Count == long_list.Count)
                                {
                                    value = long_list;
                                }
                                else if (value_list.Count == string_list.Count)
                                {
                                    value = string_list;
                                }
                                else
            ...
            public IStatementResult Statement(string funcname, params object[] args)
            {
            ...
            public IFunctionResult Function(string funcname, params object[] args)
            {
