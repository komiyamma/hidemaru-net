...
namespace Microsoft.ClearScript.V8.SplitProxy
{
    internal static partial class V8SplitProxyNative
    {
        ...
        #region Nested type: WinX86Impl

        private sealed class WinX86Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new WinX86Impl();
        ...
        #region Nested type: WinX64Impl

        private sealed class WinX64Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new WinX64Impl();
        ...
        #region Nested type: WinArmImpl

        private sealed class WinArmImpl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new WinArmImpl();
        ...
        #region Nested type: WinArm64Impl

        private sealed class WinArm64Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new WinArm64Impl();
        ...
        #region Nested type: LinuxX64Impl

        private sealed class LinuxX64Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new LinuxX64Impl();
        ...
        #region Nested type: LinuxArmImpl

        private sealed class LinuxArmImpl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new LinuxArmImpl();
        ...
        #region Nested type: LinuxArm64Impl

        private sealed class LinuxArm64Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new LinuxArm64Impl();
        ...
        #region Nested type: MacX64Impl

        private sealed class MacX64Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new MacX64Impl();
            ...
            [DllImport("ClearScriptV8.osx-x64.dylib", CallingConvention = CallingConvention.Cdecl)]
            private static extern IntPtr V8SplitProxyManaged_SetMethodTable(
                [In] IntPtr pMethodTable
            );
        ...
        #region Nested type: MacArm64Impl

        private sealed class MacArm64Impl : IV8SplitProxyNative
        {
            public static readonly IV8SplitProxyNative Instance = new MacArm64Impl();
            ...
            [DllImport("ClearScriptV8.osx-arm64.dylib", CallingConvention = CallingConvention.Cdecl)]
            private static extern IntPtr V8SplitProxyManaged_SetMethodTable(
                [In] IntPtr pMethodTable
            );
