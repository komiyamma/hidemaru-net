    ...
    public sealed partial class Hidemaru
    {
        public sealed class ExplorerPane
        {
            ...
            public static string GetProject()
            {
                try
                {
                    if (hmLmDynamicLib.Hidemaru.Macro.IsExecuting)
                    {
                        string cmd = @"dllfuncstr(loaddll(""HmExplorerPane""), ""GetProject"", hidemaruhandle(0))";
                        string project_name = (string)hmLmDynamicLib.Hidemaru.Macro.Var[cmd];
                    ...
                    else
                    {
                        ...
                        var result = hmLmDynamicLib.Hidemaru.Macro.ExecEval(cmd);
            ...
            public static string GetCurrentDir()
            {
                ...
                try
                {
                    if (hmLmDynamicLib.Hidemaru.pExplorerPane_GetCurrentDir != null)
                    {
                        if (hmLmDynamicLib.Hidemaru.Macro.IsExecuting)
                        {
                            string cmd = @"dllfuncstr(loaddll(""HmExplorerPane""), ""GetCurrentDir"", hidemaruhandle(0))";
                            string currentdir_name = (string)hmLmDynamicLib.Hidemaru.Macro.Var[cmd];
            ...
            public static IntPtr SendMessage(int commandID)
            {
                ...
                //
                return hmLmDynamicLib.SendMessage(ExplorerPane.WindowHandle, 0x111, commandID, IntPtr.Zero);
            }
