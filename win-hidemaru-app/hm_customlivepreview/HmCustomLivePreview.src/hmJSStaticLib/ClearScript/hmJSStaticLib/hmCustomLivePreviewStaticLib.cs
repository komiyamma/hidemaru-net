...
public class ICustomLivePreviewStaticLib
{
    public static void OutputDebugStream(String error)
    {
        HmCustomLivePreviewDynamicLib.OutputDebugStream(error);
    }

    public static IntPtr CreateScope()
    {
        return HmCustomLivePreviewDynamicLib.CreateScope();
    }
    ...
    {
        return HmCustomLivePreviewDynamicLib.SetTmpVar(value);
    }

    public static Object PopTmpVar()
    {
        return HmCustomLivePreviewDynamicLib.PopTmpVar();
    }

    //-----------------------------------------------------------------
    public static IntPtr GetNumVar(String mng_var_name)
    {
        return HmCustomLivePreviewDynamicLib.GetNumVar(mng_var_name);
    }

    public static IntPtr SetNumVar(String mng_var_name, IntPtr value)
    {
        return HmCustomLivePreviewDynamicLib.SetNumVar(mng_var_name, value);
    }

    public static String GetStrVar(String mng_var_name)
    {
        return HmCustomLivePreviewDynamicLib.GetStrVar(mng_var_name);
    }

    public static IntPtr SetStrVar(String mng_var_name, String value)
    {
        return HmCustomLivePreviewDynamicLib.SetStrVar(mng_var_name, value);
    }
    //-----------------------------------------------------------------
    ...
    {
        return HmCustomLivePreviewDynamicLib.GetNumItemOfList(mng_arr_name, index);
    }

    public static IntPtr SetNumItemOfList(String mng_arr_name, IntPtr index, IntPtr value)
    {
        return HmCustomLivePreviewDynamicLib.SetNumItemOfList(mng_arr_name, index, value);
    }

    public static String GetStrItemOfList(String mng_arr_name, IntPtr index)
    {
        return HmCustomLivePreviewDynamicLib.GetStrItemOfList(mng_arr_name, index);
    }

    public static IntPtr SetStrItemOfList(String mng_arr_name, IntPtr index, String value)
    {
        return HmCustomLivePreviewDynamicLib.SetStrItemOfList(mng_arr_name, index, value);
    }
    //-----------------------------------------------------------------
    ...
    {
        return HmCustomLivePreviewDynamicLib.GetNumItemOfDict(mng_arr_name, key);
    }

    public static IntPtr SetNumItemOfDict(String mng_arr_name, String key, IntPtr value)
    {
        return HmCustomLivePreviewDynamicLib.SetNumItemOfDict(mng_arr_name, key, value);
    }

    public static String GetStrItemOfDict(String mng_arr_name, String key)
    {
        return HmCustomLivePreviewDynamicLib.GetStrItemOfDict(mng_arr_name, key);
    }

    public static IntPtr SetStrItemOfDict(String mng_arr_name, String key, String value)
    {
        return HmCustomLivePreviewDynamicLib.SetStrItemOfDict(mng_arr_name, key, value);
    }
    //-----------------------------------------------------------------

    public static IntPtr DoString(string expression)
    {
        return HmCustomLivePreviewDynamicLib.DoString(expression);
    }

    public static String OnCustomTranslateHTML(string filename)
    {
        return HmCustomLivePreviewDynamicLib.OnCustomTranslateHTML(filename);
    }

    public static IntPtr DoFile(string filename)
    {
        return HmCustomLivePreviewDynamicLib.DoFile(filename);
    }

    public static IntPtr DestroyScope()
    {
        return HmCustomLivePreviewDynamicLib.DestroyScope();
    }
...
{
    static HmCustomLivePreviewDynamicLib()
    {
    ...
    public static IntPtr CreateScope()
    {
        ...
        if (engine == null)
        {
            try
            {
                ...
                console = new HmCustomLivePreviewConsole();
                engine.AddHostType("console", typeof(HmCustomLivePreviewConsole));
