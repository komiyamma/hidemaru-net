...
public class Hm {
	...
	*/
	...
	protected static void _AddClassPath(String[] _dummy){
		...
		// addToClasspath(currentmacrodirectory);
		// Hm.debugInfo("path:" + currentmacrodirectory);
		/*
        ...
        for (File file : filelist) {
			if (file.isFile()) {
				...
				if (suffix.equalsIgnoreCase("jar")) {
					...
					// addToClasspath(currentmacrodirectory + "\\" + file.getName());
					// Hm.debugInfo("jar:" + currentmacrodirectory + "\\" + file.getName());
				}
			}
        }
